        ...
        <div className='masonry-grid row mb-5'>
          ...
          <div className='masonry-grid-item col-lg-6 g-mb-100'>
            <div className='g-pr-40--lg'>
              ...
              <hr />
              {/* <a className='smoothscroll btn btn-xl u-btn-outline-black g-font-weight-600 g-font-size-default g-px-35' href='#technicals'>I am convinced</a> */}
              <ul className='list-inline'>
                ...
                <a className='smoothscroll btn btn-l u-btn-outline-black g-font-weight-500 g-font-size-default g-px-15' href='#technicals' style={{ marginLeft: 190 }}>I am convinced</a>
              </ul>
