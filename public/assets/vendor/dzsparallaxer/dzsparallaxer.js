...
(function ($) {
  $.fn.dzsparallaxer = function (o) {
    ...
    this.each(function () {
      var cthis = $(this)
      var _theTarget = null
      var _blackOverlay = null
      var _fadeouttarget = null
      ...
      var ww = 0
      var wh = 0
      var last_wh = 0 // -- compare to the last known last wh
      var last_cthis_ot = 0 // -- compare to the last known last wh
      var initialheight = 0
      ...
      var _scrollTop_is_another_element_top = null

      var st = 0 // --scroll top
      var vi_y = 0 // -- view index y
      var bo_o = 0 // -- black offset opacity
      var cthis_ot = 0 // --offset top
      ...
      var sw_suspend_functional = false
      var sw_stop_enter_frame = false
      var sw_out_of_display = false

      var init_delay = 0
      var init_functional_delay = 0

      var inter_debug_func = 0
      var inter_suspend_enter_frame = 0
      var inter_scroll_from_resize = 0
      var inter_recheck_dims = 0

      // -- some rresponsive scaling options

      var responsive_reference_width = 0
      var responsive_optimal_height = 0
